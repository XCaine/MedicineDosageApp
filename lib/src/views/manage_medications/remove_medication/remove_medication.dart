...
import 'package:drugs_dosage_app/src/views/manage_medications/remove_medication/remove_medication_dao.dart';
...
class _RemoveMedicationState extends State<RemoveMedication> {
  ...
  final _removeMedicationDao = RemoveMedicationDao();
  ...
  void deleteMedication(BasicMedicalRecord medicalRecord) {
    CloseWizardDialog.show(
        ...
        () => {_removeMedicationDao.deleteMedication(medicalRecord.id), showSnackBar(medicalRecord.productName)});
  }
